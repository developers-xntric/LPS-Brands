...
export default function BrandingStart() {
  return (
    <Wrapper>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-[-70px] left-20 bg-blue text-white px-8 py-6 rounded-full max-w-xl">
              <h2 className="text-4xl md:text-5xl font-bold leading-tight text-center">
                The Future of Leadership Branding Starts Here
              </h2>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10  leading-relaxed">
          <div>
            <p className="text-secondary font-medium leading-7 text-lg font-['Exo'] max-w-4xl mx-auto">
              Leadership branding is no more optional in a society where leaders
              are expected to inspire, influence, and start change. At LPS, we
              think that in the crowded scene of today, visionary leaders differ
              mostly in their strong personal leadership brand. We create
              magnetic identities that platforms promote, communities gather
              behind, and businesses remember; we do not just create exposure.
            </p>
          </div>
