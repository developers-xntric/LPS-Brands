...
export default function CareersSecond() {
  ...
  return (
    <div className="flex flex-col items-center justify-center pt-60 2xl:pt-[350px] ">
      <div className="2xl:max-w-[1700px] mx-auto w-[95%] flex flex-col space-y-12">
        <div className="text-left ">
          <h2 className="text-[50px] font-['Asgard'] font-semibold ">
            Join our team
          </h2>
        ...
        <div className="grid grid-cols-2 gap-x-16 gap-y-8 ">
          {careersData.map((job, index) => (
            <div
              key={index}
              className="bg-[#101820] text-white px-8 py-10 rounded-[25px]"
            >
              ...
              <h2 className="text-[30px] xl:text-[40px] font-bold mt-2">
                {job.title}
              </h2>
              <p className="2xl:text-2xl font-['Exo'] leading-relaxed py-3 text-white">
                {job.description}
              </p>
              <div className="mt-4 flex items-center gap-5 ">
                <span className="mr-2 flex items-center font-light gap-2 text-[20px]">
                  <MapPin size={20} /> {job.location}
                </span>
                <span className="flex items-center font-light gap-2 text-[20px]">
