        ...
        <div>
            <div className="grid grid-cols-4 gap-6">
                {videos.map((video) => (
                    <div
                        key={video.id}
                        className="bg-slate-800 rounded-2xl overflow-hidden cursor-pointer hover:scale-105 transition-transform duration-300 shadow-lg"
                    ...
                    >
                        <div className="relative">
                            ...
                            <div className="absolute top-3 right-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg p-1">
