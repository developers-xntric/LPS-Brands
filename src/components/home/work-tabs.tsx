        ...
        <div className="mx-auto xl:px-8">
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-start font-['Exo']">
                ...
                <div className="space-y-4 w-full lg:w-[60%]">
                    {/* Identity Section */}
                    <div
                        className={`space-y-4 cursor-pointer transition-all duration-300 rounded-2xl p-6 hover:border hover:border-[#00FC09] hover:bg-[#00FC09]/10 ${activeTab === "identity" ? "border border-green bg-[#00FC09]/10" : "border border-transparent bg-[#141E29]"} lg:block`}
                        onClick={() => setActiveTab("identity")}
                    >
                        <div className={`inline-block px-8 py-2 rounded-full ${activeTab === "identity" ? "bg-white text-secondary" : "bg-white text-secondary"}`}>
                    ...
                    <div className={`lg:hidden ${activeTab === "identity" ? "block" : "hidden"}`}>
                        <Card className="bg-white text-black p-8 rounded-[35px]">
                            <div className="space-y-6">
                                ...
                                {/* Dynamic Title */}
                                <h2 className="text-2xl md:text-5xl font-bold whitespace-pre-line">{tabData.identity.title}</h2>
                    ...
                    <div
                        className={`space-y-4 cursor-pointer transition-all duration-300 rounded-2xl hover:border hover:border-[#00FC09] hover:bg-[#00FC09]/10 p-6 ${activeTab === "communications" ? "border border-green bg-[#00FC09]/10" : "border border-transparent bg-[#141E29]"} lg:block`}
                        onClick={() => setActiveTab("communications")}
                    >
                        <div className={`inline-block px-8 py-2 rounded-full ${activeTab === "communications" ? "bg-white text-secondary" : "bg-white text-secondary"}`}>
                    ...
                    <div className={`lg:hidden ${activeTab === "communications" ? "block" : "hidden"}`}>
                        <Card className="bg-white text-black p-8 rounded-[35px]">
                            <div className="space-y-6">
                                {/* Icon */}
                                <div className="w-14 h-14 bg-black rounded-full flex items-center justify-center">
                                ...
                                {/* Dynamic Title */}
                                <h2 className="text-2xl md:text-5xl font-bold whitespace-pre-line">{tabData.communications.title}</h2>
                    ...
                    {/* Experiences Section */}
                    <div
                        className={`space-y-4 cursor-pointer transition-all duration-300 rounded-2xl p-6 hover:border hover:border-[#00FC09] hover:bg-[#00FC09]/10 ${activeTab === "experiences" ? "border border-green bg-[#00FC09]/10" : "border border-transparent bg-[#141E29]"} lg:block`}
                        onClick={() => setActiveTab("experiences")}
                    >
                        <div className={`inline-block px-8 py-2 rounded-full ${activeTab === "experiences" ? "bg-white text-secondary" : "bg-white text-secondary"}`}>
                    ...
                    <div className={`lg:hidden ${activeTab === "experiences" ? "block" : "hidden"}`}>
                        <Card className="bg-white text-black p-8 rounded-[35px]">
                            <div className="space-y-6">
                                {/* Icon */}
                                <div className="w-14 h-14 bg-black rounded-full flex items-center justify-center">
                                ...
                                {/* Dynamic Title */}
                                <h2 className="text-2xl md:text-5xl font-bold whitespace-pre-line">{tabData.experiences.title}</h2>
