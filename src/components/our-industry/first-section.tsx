    ...
    <div className='-mt-24 mb-32'>
        <div className='w-[90%] mx-auto 2xl:max-w-[1740px]' >
            ...
            <div className='flex justify-between items-center my-20 '>
                <h2 className='text-[#101820] text-[30px] 2xl:text-[55px] font-semibold leading-[33px] 2xl:leading-[55px] max-w-[45%]'>{head1}</h2>
                <p className='font-["Exo"] text-[15px] 2xl:text-[20px] max-w-[50%] text-[#212121]'>{para1}</p>
            </div>
