        ...
        <div className="flex justify-between items-center gap-12 ">
          ...
          <div className="space-y-6 w-1/2">
            ...
            <div className=" max-w-[85%]  relative">
              ...
              <div className="ml-10">
                <p className="text-gray-700 leading-relaxed text-[15px] 2xl:text-[20px] font-['Exo']">
                  {para1}
                </p>
                <p className="text-gray-700 leading-relaxed text-[15px] 2xl:text-[20px] mt-10 font-['Exo']">
                  {para2}
                </p>
              </div>
            </div>
