...
const Events = () => {
    return (
        <div>
            ...
            />
            <ServicesHero heading='Event Management' highlight='Event Management' bottom={false} />
            ...
            <Timeline
                ...
                timelineData={[{
                    ...
                    description: "We craft event journeys from the audience’s perspective—mapping key moments, emotional triggers, and interactive elements that turn participation into passion.",
                },
                {
                    title: "Immersive Brand Activations",
                    description: "From pop-ups and showcases to live demos and installations, we turn brands into environments—blending physical presence with digital storytelling.",
                },
                {
                    title: "Hybrid & Digital Amplification",
                    description: "We design events that scale across platforms—integrating live streaming, social engagement, and influencer collaborations to extend reach far beyond the venue.",
                },
                {
                    title: "End-to-End Strategy & Execution",
                    description: "We manage every detail—from concept, scripting, and creative direction to logistics, tech, and production—ensuring seamless execution across all touchpoints.",
                }]}
            />
            <BuildingBrandsCards
