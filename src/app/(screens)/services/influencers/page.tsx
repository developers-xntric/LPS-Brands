...
const schemaData = {
    ...
    "description": "Influencer Marketing Agency that Builds Brands Through Authentic Influence",
    "provider": {
        "@type": "Organization",
        "name": "LPS Brands",
...
const Influencers = () => {
    return (
        <div>
            ...
            />
            <ServicesHero heading='Influencer Marketing' highlight='Influencer Marketing' bottom={false} />
            ...
            <Timeline
                ...
                timelineData={[{
                    ...
                    description: "We go beyond follower counts—aligning brands with influencers who share their values, speak their language, and move their audience from passive to passionate.",
                },
                {
                    title: "Native Platform Fluency",
                    description: "We tailor influencer content to feel seamless and contextual—whether it’s a TikTok transition, a long-form YouTube review, or a quiet LinkedIn perspective that sparks industry buzz.",
                },
                {
                    title: "Narrative-Led Collaborations",
                    description: "Each campaign is anchored in story. We build influencer partnerships around authentic narratives that audiences trust—bridging brand goals with personal voice.",
                },
                {
                    title: "Influencer Identity Crafting",
                    description: "From content strategy to visual styling, we work with influencers to elevate their personal brand—ensuring they show up not just as creators, but as thought leaders in their niche.",
                }]}
            />
            <BuildingBrandsCards
            ...
            <Wrapper>
                <div className='py-16'>
                    <h2 className='text-6xl text-center font-bold'>Let’s Build Influence That Lasts</h2>
                    <p className='text-xl max-w-5xl mx-auto font-medium text-center mt-10'>Looking for an influencer marketing agency that doesn’t just follow trends, but creates them? Let’s collaborate. Get in touch to build your next creator-powered campaign.
                    </p>
                </div>
            </Wrapper>
