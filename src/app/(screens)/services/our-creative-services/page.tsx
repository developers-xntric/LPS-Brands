...
const schemaData2 = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://lps-me.com/services/our-creative-services/",
      "url": "https://lps-me.com/services/our-creative-services/",
      "name": "Creative Branding Agency | LPS Creative Services",
      "isPartOf": {
      ...
      "thumbnailUrl": "https://lps-me.com/wp-content/uploads/2025/04/two-diverse-members-working-team-think-cretive-ideas-future-project-woman-shows-design-plan-smartphone-webpage-pose-desktop.png",
      "datePublished": "2025-04-09T07:49:57+00:00",
      "dateModified": "2025-07-21T11:16:25+00:00",
      "description": "LPS is a creative branding agency in Dubai offering impactful brand design, storytelling, and campaigns built on cultural insight and performance-driven craft.",
      "breadcrumb": {
        "@id": "https://lps-me.com/services/our-creative-services/#breadcrumb"
      },
      "inLanguage": "en-US",
      "potentialAction": [
        {
          "@type": "ReadAction",
          "target": [
            "https://lps-me.com/services/our-creative-services/"
          ]
        }
      ]
    },
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Creative Communication Services"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "logo": {
        ...
        "url": "https://lps-me.com/wp-content/uploads/2025/01/lps-logo.png",
        "contentUrl": "https://lps-me.com/wp-content/uploads/2025/01/lps-logo.png",
        "width": 749,
        "height": 449,
        "caption": "LPS Brands"
      },
        ...
        timelineData={[
          {
            ...
            description:
              "We start with a deep dive into audience behavior, cultural relevance, and digital patterns—ensuring every idea is born from insight and built to resonate across communities.",
          },
          {
            title: "Native-First Creative Thinking",
            description:
              "Every visual, voice, and format is crafted with contextual precision—whether it’s a cinematic billboard, a TikTok trend, or a luxury print campaign. The story flexes, but the brand stays consistent.",
          },
          {
            title: "Unified Narrative Architecture",
            description:
              "Our campaigns are built with a single, compelling narrative that translates across formats and moments—bridging audiences with cohesion, clarity, and emotional pull.",
          },
          {
            title: "Cross-Disciplinary Creative Craft",
            description:
              "From visual artists to motion designers, strategists to experience makers—our creative teams work as one to deliver bold, immersive brand stories without losing sight of performance.",
          },
        ]}
      />
      <BuildingBrandsCards
      ...
      <Wrapper>
        <div className="lg:py-16 pb-16">
          ...
          <p className="lg:text-xl max-w-5xl mx-auto font-medium text-center 2xl:mt-10 mt-5">
            agency—we are the most natural interpreter for your brand. Being
            forward-looking creative branding consultants, we explore
            strategically smart, emotionally compelling, and difficult to ignore
            deep insights into immersive brand experiences.
          </p>
          <p className="lg:text-xl max-w-5xl mx-auto font-medium text-center 2xl:mt-10 mt-5">
            Our team brings innovative branding concepts to life with clarity
            and impact whether your project is starting a new product, changing
            your identity, or designing a campaign spanning several cultures and
            media. From Dubai to the world stage, we create strong, relevant,
            and performance-oriented brand narratives. Since only companies with
            innovative creative branding design stand out in a noisy
            environment. And only purposeful innovation is really enduring.
          </p>
        </div>
      </Wrapper>
