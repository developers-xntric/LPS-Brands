    ...
    <div>
      ...
      <div className='2xl:max-w-[1740px] w-[90%] mx-auto my-20 font-["Exo"]'>
        <p className='text-[16px]'>
          ...
          <br /><br />
          These Terms of Use (“Terms”) governs your use of the website, located at MyPrivateTutor, any mobile applications, and services (“Site”) provided by Learnpick Technologies Inc (“” or “us” or “we” or “our”) having its registered office at 2928 Redbud Ave, Oakville ON L6J 7J4, Canada.
          <br /><br />
          PLEASE READ THESE TERMS OF USE CAREFULLY BEFORE USING THIS SITE, DOWNLOADING, INSTALLING OR USING OUR MOBILE APPLICATION. BY ACCESSING, REGISTERING OR USING THIS SITE, YOU AGREE TO BE BOUND BY THESE TERMS, INCLUDING THE DISCLAIMERS SET FORTH BELOW AND THE PRIVACY POLICY. IF YOU ARE NOT WILLING TO BE BOUND BY THESE TERMS OF USE, INCLUDING THE DISCLAIMERS AND PRIVACY POLICY, YOU MAY NOT ACCESS OR USE THIS SITE OR DOWNLOAD OUR MOBILE APPLICATION.
          <br /><br />
          ...
          <br /><br />
          <strong className='text-[30px]'>Restricted Activities</strong>
          <br /><br />
