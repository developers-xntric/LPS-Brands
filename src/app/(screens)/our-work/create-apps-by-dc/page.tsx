...
export const metadata = {
  title: "Create Apps by DC​ - LPS Brands",
  description:
    "Dubai Chamber of Digital Economy launched the &quot;Create Apps in Dubai&quot; initiative to establish itself as a leader in digital innovation. The goal was to create a unified brand presence to position Dubai as a global tech hub.",
  alternates: {
    canonical: "https://lps-me.com/our-work/create-apps-by-dc",
  },
};
  ...
  return (
    <div>
      <WorkHero
        ...
        heading="Create Apps by DC"
        highlight="presence"
        text="Dubai Chamber of Digital Economy launched the “Create Apps in Dubai” initiative to position the city as a global hub for app development. The goal was to secure two hundred sign-ups for the App Olympics program, targeting young Emirati coders. Reaching this entrepreneurial community required innovative strategies, as traditional channels were less effective.​​"
        bottom={false}
      />
      <ImpactSection
        video1="https://player.vimeo.com/video/1011538392?color&autopause=0&loop=0&muted=0&title=1&portrait=1&byline=1#t="
