...
function NotFound() {
    return (
        <Wrapper>
            ...
            <div className='2xl:max-w-[1740px] min-h-[8`0vh] w-[90%] text-center font-bold mx-auto text-blue text-[30px] md:text-[70px] flex flex-col items-center justify-center '>
                ...
                <Link href={"/home"} className='mt-10 md:mt-20'>
